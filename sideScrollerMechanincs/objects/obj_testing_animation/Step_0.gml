...
point_x = xstart +lengthdir_x(60,_value);
...
var _value = animcurve_channel_evaluate(_channel,time);
ystart = y;
point_y = ystart + lengthdir_y(60,_value);
...
part_type_scale(obj_particle_controller.pt_flare_particles_testing, 1,2);
part_type_orientation(obj_particle_controller.pt_flare_particles_testing, _value, _value,0, 0, 0);
